    ...
    def load_documents(self, uploaded_files) -> List[Document]:
        try:
            ...
            for uploaded_file in uploaded_files:
                # print('uploaded_file _____',uploaded_file.filename )
                # print('uploaded_file _____',uploaded_file.file)
                # print('uploaded_file _____',uploaded_file)
                ...
                with tempfile.NamedTemporaryFile(delete=False, suffix=suffix) as temp_file:
                    ...
                    print('temp_file.name_____',temp_file.name)
                    print('temp_file_____',temp_file)
